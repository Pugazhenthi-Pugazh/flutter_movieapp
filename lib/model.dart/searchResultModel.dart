...
class SearchResult {
  ...
  int page;
  List<SearchMoiveResult> results;
  int totalPages;
  int totalResults;

  factory SearchResult.fromJson(Map<String, dynamic> json) => SearchResult(
        page: json["page"],
        results: List<SearchMoiveResult>.from(
            json["results"].map((x) => SearchMoiveResult.fromJson(x))),
...
class SearchMoiveResult {
  ...
  factory SearchMoiveResult.fromJson(Map<String, dynamic> json) =>
      SearchMoiveResult(
        adult: json["adult"],
